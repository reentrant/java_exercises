...
public class EdxIO implements Closeable {
     ...
     *
     * It has an abstract method {#receive(EdxIO)} for doing the real work when the EdxIO instance
     * is created, and an implementation of public-static-void-main which creates an instance and 
     * delegates to {#receive(EdxIO)}.
     */
    public static abstract class Receiver {
         ...
         *
         * @deprecated use the {@code new Array[Byte]} syntax which also does not load the Scala 
         * library.
         ...
         * without having to load the Scala library.
         *
         * @deprecated use the {@code new Array[Int]} syntax which also does not load the Scala 
         * library.
         * @param n the number of elements.
         ...
         * without having to load the Scala library.
         *
         * @deprecated use the {@code new Array[Long]} syntax which also does not load the Scala 
         * library.
         * @param n the number of elements.
         ...
         * without having to load the Scala library.
         *
         * @deprecated use the {@code new Array[Double]} syntax which also does not load the Scala 
         * library.
         * @param n the number of elements.
         ...
         *
         * @deprecated use the {@code new Array[T]} syntax which also does not load the Scala 
         * library.
     ...
     * <li>skip all whitespace until the next non-whitespace symbol;</li>
     * <li>consume all non-whitespace symbols until the next whitespace symbol;</li>
     * <li>invoke {@link Double#parseDouble(String)} on the resulting character sequence and return
     * the result.</li>
     * </ul>
     *
     * Regardless of whether double parsing is successful, the stream pointer for the input file 
     * points to the first
    ...
    /**
     * Reads from the input file and returns the next double.
     * This is a custom implementation which is not guaranteed to read all doubles 
     * {@link #nextDoublePrecise()} does, nor guaranteed to return the same values as 
     * {@link #nextDoublePrecise()} does on the same  input.
     ...
     * <li>if the next symbol is a dot, skip this dot and continue, otherwise return the long value
     *  which has just been read;</li>
     * <li>try reading a long, interpret it as a decimal part of the double, add it up with the 
     * first long, checking signs.</li>
     * <li>if the next symbol is either 'e' or 'E', skip this symbol and continue, otherwise return
     *  the result of the previous step.</li>
     * <li>try reading an int, interpret it as an exponent, apply it and return the value.</li>
     * </ul>
     *
     * The state of the stream after returning from this function depends on the input as if exactly
    ...
    /**
     * Skips all whitespace symbols in the input file until the first non-whitespace symbol is
     *  found, such that the subsequent call to {#currentSymbol()} returns this symbol.
     */
